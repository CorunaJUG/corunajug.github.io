$().ready(function() {
    ...
    // Upcoming events
    $.ajax({
        url: '//api.meetup.com/CorunaJUG/events?status=upcoming&fields=featured_photo',
        dataType: 'jsonp',
        jsonp: 'callback',
    ...
    // Past events
    $.ajax({
        url: '//api.meetup.com/CorunaJUG/events?status=past&fields=featured_photo&page=6&desc=true',
        dataType: 'jsonp',
        jsonp: 'callback',
        success: function(response) {
            $.each(response.data, function() {
